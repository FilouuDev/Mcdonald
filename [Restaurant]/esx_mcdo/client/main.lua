...
function IsJobTrue()
    if PlayerData ~= nil then
        ...
        if PlayerData.job ~= nil and PlayerData.job.name == 'mcdo' then
            IsJobTrue = true
        end
        return IsJobTrue
    end
...
function OpenVaultMenu()
    ...
    if data.current.value == "cocacola" then
		...
		TriggerServerEvent('esx_mcdojob:shop', data.current.value, valor)
      end,
...
function OpenCozinharMenu()
	...
	local elements = {
      {label = "Hamburger", value = 'ctomato'},
      {label = "Poutine", value = 'clettuce'},
      {label = "Frites", value = 'ccheese'},
    }
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        TriggerServerEvent('esx_mcdojob:craftingCoktails', data.current.value)
      ...
      function(data, menu)
        ...
        CurrentActionMsg  = "Appuyer Sur ~INPUT_CONTEXT~ Pour Cuisiner"
        CurrentActionData = {}
      end
    )
    ...
    ESX.TriggerServerCallback('esx_society:getVehiclesInGarage', function(garageVehicles)
      ...
      ESX.UI.Menu.Open(
        ...
        function(data, menu)
          ...
          TriggerServerEvent('esx_society:removeVehicleFromGarage', 'mcdo', vehicleProps)
...
function OpenSocietyActionsMenu()
  ...
  ESX.UI.Menu.Open(
    'default', GetCurrentResourceName(), 'mcdo_actions',
    {
      title    = "Billing",
      align    = 'top-left',
      elements = elements
  ...
  ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'billing', {
    ...
    if amount == nil or amount < 0 then
      ...
      if closestPlayer == -1 or closestDistance > 3.0 then
        ...
        menu.close()
        TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(closestPlayer), 'society_mcdo', _U('mcdo'), amount)
      end
    end
...
function OpenGetStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_mcdojob:getStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_mcdojob:getStockItem', itemName, count)
            end
...
ESX.TriggerServerCallback('esx_mcdojob:getPlayerInventory', function(inventory)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_mcdojob:putStockItems', itemName, count)
            end
...
function OpenGetFridgeStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_mcdojob:getFridgeStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_mcdojob:getFridgeStockItem', itemName, count)
            end
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_mcdojob:putFridgeStockItems', itemName, count)
            end
...
function OpenGetWeaponMenu()
  ...
  ESX.TriggerServerCallback('esx_mcdojob:getVaultWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_mcdojob:removeVaultWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      ESX.TriggerServerCallback('esx_mcdojob:addVaultWeapon', function()
        OpenPutWeaponMenu()
      end, data.current.value)
...
function OpenShopMenu(zone)
    ...
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'mcdo_shop',
        {
            title    = _U('shop'),
            elements = elements
        },
        function(data, menu)
            TriggerServerEvent('esx_mcdojob:buyItem', data.current.value, data.current.price, data.current.realLabel)
        end,
        function(data, menu)
            menu.close()
        end
...
AddEventHandler('esx_mcdojob:hasEnteredMarker', function(zone)
...
AddEventHandler('esx_mcdojob:hasExitedMarker', function(zone)
    ...
    while true do
        ...
        if IsJobTrue() then
            ...
            if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
                ...
                TriggerEvent('esx_mcdojob:hasEnteredMarker', currentZone)
            end

            if not isInMarker and HasAlreadyEnteredMarker then
                HasAlreadyEnteredMarker = false
                TriggerEvent('esx_mcdojob:hasExitedMarker', LastZone)
            end
...
Citizen.CreateThread(function()
  while true do
      ...
      if IsControlJustReleased(0,  Keys['E']) and IsJobTrue() then
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            TriggerServerEvent('esx_society:putVehicleInGarage', 'mcdo', vehicleProps)
            ...
            then
              TriggerServerEvent('esx_service:disableService', 'mcdo')
            end
    ...
    if IsControlJustReleased(0,  Keys['F6']) and IsJobTrue() and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'mcdo_actions') then
...
RegisterNetEvent('esx_mcdo:StartCookAnimation')
AddEventHandler('esx_mcdo:StartCookAnimation', function()
...
RegisterNetEvent('esx_mcdo:StopCookAnimation')
AddEventHandler('esx_mcdo:StopCookAnimation', function()
local ped = GetPlayerPed(-1)
